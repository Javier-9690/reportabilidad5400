...
OPTIONAL_RECORD_FIELDS = {
    ...
    "samtech_qr": SAMTECH_USER_FIELDS,
}
...
EDIT_CONFIG = {
    ...
    "samtech_qr": ("Solicitudes de usuarios Samtech QR", " ".join(name for name, _ in SAMTECH_USER_FIELDS)),
}
...
def edit_fields(entity, record):
    ...
    labels = {
        ...
        "samtech_qr": dict(SAMTECH_USER_FIELDS),
...
def parse_edit_values(entity, fields, form):
    ...
    if not errors:
        ...
        elif entity in ("ordenamiento", "habitaciones_liberadas", "samtech_usuarios", "samtech_qr") and all(value is None for value in values.values()):
            errors["_form"] = "Ingresa al menos un dato para guardar el registro."
