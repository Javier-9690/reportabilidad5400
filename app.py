...
def report_xlsx_fast(data, progress_callback=None):
    ...
    - Exporta solo el reporte por gerencia, sin anexar el censo global.
    - Los censos acumulados se descargan aparte como CSV liviano.
    ...
    # Nota: el reporte de dotación por gerencia queda separado de los censos acumulados.
    # Los censos acumulados se exportan desde el botón CSV liviano para evitar archivos
    # demasiado pesados y tiempos de respuesta altos en Render.
    if progress_callback:
        progress_callback('Finalizando reporte de dotación por gerencia...')
